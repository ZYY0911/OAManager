...
{
    public partial class 亡故员共 : Form
    {
        string worknum;
        public UpDate upDate;
        public 亡故员共(string worknum, UpDate upDate)
        {
            this.upDate = upDate;
        ...
        private void 亡故员共_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            new deathTableAdapter().Insert(dateTimePicker1.Value, textBox1.Text
